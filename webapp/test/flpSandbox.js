		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#BibliotecaDigital-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"BibliotecaDigital-display": {
								"semanticObject": "BibliotecaDigital",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=becloud.cl.project1",
									"url": sap.ui.require.toUrl("becloud/cl/project1")
								}
							}
						}
					}
